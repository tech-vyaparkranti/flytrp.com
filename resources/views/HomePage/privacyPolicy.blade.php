        ...
        <div class="default-content pt-2 pb-2">
            <div class="container">
                ...
                <div class="midd-content">
                    <p class="text-justify">Welcome to FLYTRP Holidays. By using our website and services, you agree to our privacy policy, which outlines how we collect, use, and protect your data. 
                  </p>
                    ...
                    <p class="text-justify">FLYTRP Holidays PVT LTD collects user information solely for statutory and promotional purposes. This includes contact details (email, address, phone number), age, country, and travel history. Information submitted via website forms is used to send promotional content, and users may opt out at any time.</p>
                    
                    <h5>Website Tracking & User Experience</h5>
                    <p class="text-justify">We track domain names and page visits to analyze website traffic and improve user experience. This statistical data helps us refine our services and enhance customer satisfaction. Advertisers associated with FLYTRP Holidays may send promotional emails, which users can unsubscribe from at their discretion.</p>
                    ...
                    <p class="text-justify">FLYTRP Holidays PVT LTD reserves the right to modify or remove any section of this privacy policy without prior notice. Updates will be reflected on our website.</p> 
