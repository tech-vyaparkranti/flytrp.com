        ...
        {{-- <div class="container-fluid  pb-3"> --}}
            <div class="container">
                ...
                <div class="midd-content">
                    {{-- <p class="text-justify">These Terms and Conditions, along with privacy policy or other terms (“Terms”) constitute a binding agreement by and between FLYTRP, ( “Website Owner” or “we” or “us” or “our”) and you (“you” or “your”) and relate to your use of our website, goods (as applicable) or services (as applicable) (collectively, “Services”).</p>
                    ...
                    <ul class="points">
                        ...
                        <li><p class="text-justify">FLYTRP Holidays is not responsible for flight rescheduling or cancellations by airlines and their impact on related bookings.</p></li>
                        ...
                        <li><p class="text-justify">Airfares may change without prior notice, and FLYTRP Holidays will not be liable for such changes.</p></li>
                        ...
                        <li><p class="text-justify">Travel insurance claims must be settled between the guest and the insurance company; FLYTRP Holidays holds no liability.</p></li>
                        <li><p class="text-justify">PAN cards are mandatory for all travelers and must be submitted at the time of booking.</p></li>
                        <li><p class="text-justify">Visa approval or rejection is at the sole discretion of the embassy, and FLYTRP Holidays is not liable for any decisions.</p></li>
                        ...
                        <li><p class="text-justify">FLYTRP Holidays charges a non-refundable cancellation fee of ₹5,000 per person.</p></li>
                        ...
                        <li><p class="text-justify">Guests testing positive for COVID-19 during the tour will bear all quarantine and testing expenses, as FLYTRP Holidays is not responsible for such costs.</p></li>
                        ...
                        <li><p class="text-justify">Travel insurance is highly recommended and should be arranged by the guest or through FLYTRP Holidays before traveling.</p></li>
                    </ul>
